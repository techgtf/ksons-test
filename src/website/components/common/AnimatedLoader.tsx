...
const AnimatedLoader = forwardRef<AnimatedLoaderHandle>((_, ref) => {
  ...
  const runAnimation = () => {
    ...
    // 1️⃣ Fade in logo parts with slight overlap for a fast, elegant reveal
  ...
  return (
    <div
      ref={wrapperRef}
      id="homepage-loader"
      className="hidden md:flex fixed inset-0 z-[9999] bg-white items-center justify-center will-change-transform"
